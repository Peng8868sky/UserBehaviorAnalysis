...
object HotItems {
  def main(args: Array[String]): Unit = {
    ...
    properties.setProperty("bootstrap.servers", "spark2.x:9092")
    ...
    // 2. 读取数据
   // val dataStream = env.readTextFile("D:\\Flink\\work-project\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv")
